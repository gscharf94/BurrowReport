...
async function setupPage(url, loginInfo = { login: 'null', pass: 'null' }) {
...
async function getTicketInfoOhio(ticket) {
    ...
    await (0, webScraping_js_1.typeAndWaitSelector)(page, ticketSearchInputSelector, 0, ticket);
    let searchButtonSelector = "#btnSearch";
    await (0, webScraping_js_1.clickAndWaitSelector)(page, searchButtonSelector, 0);
